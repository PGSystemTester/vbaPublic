...
Option Compare Text
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
'Pg Note: Reposting to ensure great work from Chip lives on....
' more stuff here: https://github.com/PGSystemTester/vbaPublic/blob/main/wordSBrandTool/ChipPearsonArrays.md
' modArraySupport
...
Function ConcatenateArrays(ResultArray As Variant, ArrayToAppend As Variant, _
...
Function CopyArray(DestinationArray As Variant, SourceArray As Variant, _
        Optional NoCompatabilityCheck As Boolean = False) As Boolean
	'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
	' CopyArray
...
Function CopyArraySubSetToArray(InputArray As Variant, ResultArray As Variant, _
...
Function CopyNonNothingObjectsToArray(ByRef SourceArray As Variant, _
...
Function DataTypeOfArray(Arr As Variant) As VbVarType
	''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
	' DataTypeOfArray
	'
...
Function DeleteArrayElement(InputArray As Variant, ElementNumber As Long, _
...
Function FirstNonEmptyStringIndexInArray(InputArray As Variant) As Long
	''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
	' FirstNonEmptyStringIndexInArray
...
Function InsertElementIntoArray(InputArray As Variant, Index As Long, _
...
Function IsArrayAllDefault(InputArray As Variant) As Boolean
	''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
	' IsArrayAllEmpty
...
Function IsArrayAllNumeric(Arr As Variant, _
...
Function IsArrayDynamic(ByRef Arr As Variant) As Boolean
	''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
	' IsArrayDynamic
...
Function IsArrayObjects(InputArray As Variant, _
...
Function IsNumericDataType(TestVar As Variant) As Boolean
	''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
	' IsNumericDataType
	'
...
Function IsVariantArrayConsistent(Arr As Variant) As Boolean
	''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
	' IsVariantArrayConsistent
	'
...
Function IsVariantArrayNumeric(TestArray As Variant) As Boolean
	''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
	' IsVariantArrayNumeric
	'
...
Function MoveEmptyStringsToEndOfArray(InputArray As Variant) As Boolean
	''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
Function NumElements(Arr As Variant, Optional Dimension = 1) As Long
	''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
	' NumElements
...
Function ResetVariantArrayToDefaults(InputArray As Variant) As Boolean
	''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
	' ResetVariantArrayToDefaults
...
Function ReverseArrayInPlace(InputArray As Variant, _
...
Function ReverseArrayOfObjectsInPlace(InputArray As Variant, _
		Optional NoAlerts As Boolean = False) As Boolean
	''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
	' ReverseArrayOfObjectsInPlace
	' This procedure reverses the order of an array in place -- this is, the array variable
...
Function SetObjectArrayToNothing(InputArray As Variant) As Boolean
	''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
Function AreDataTypesCompatible(DestVar As Variant, SourceVar As Variant) As Boolean
	''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
	' AreDataTypesCompatible
...
Sub SetVariableToDefault(ByRef Variable As Variant)
	''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
	' SetVariableToDefault
...
Function TransposeArray(InputArr As Variant, OutputArr As Variant) As Boolean
	'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
	' TransposeArray
...
End Function
Function VectorsToArray(Arr As Variant, ParamArray Vectors()) As Boolean
	'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
	' VectorsToArray
...
Function ChangeBoundsOfArray(InputArr As Variant, _
...
Function IsArraySorted(TestArray As Variant, _
...
Function CombineTwoDArrays(Arr1 As Variant, _
